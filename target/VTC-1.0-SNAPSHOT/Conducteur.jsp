...
<table class="table container mt-5">
    <thead>
    <tr>
        <th scope="col" class="text-center">id_conducteur</th>
        ...
        <tr>
            ...
            <td class="text-center">
                <form action="${pageContext.request.contextPath}/conducteur-servlet" method="post">
                    ...
                    <input type="hidden" name="idConductor" value="${element.getId()}">
                    <button>
    ...
    <c:if test="${variable.size() == 0 }">
        <h1 class="container text-center my-5">Pas de conducteurs disponible</h1>
    </c:if>
    </tbody>
</table>
<form class="container w-25 mb-5" action="${pageContext.request.contextPath}/conducteur-servlet" method="post">
    <input type="hidden" name="purpose" value="C">
    <div class="form-group">
        <label for="prenomField">Prenom</label>
        <input type="text" class="form-control" id="prenomField" name="prenom"
               value="${currentConducteur != null ? currentConducteur.getPrenom() : ""}">
    </div>
    <div class="form-group">
